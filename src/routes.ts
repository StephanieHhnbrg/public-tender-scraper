...
import {inputKeyword, updatePaginator, clickOnSearchButton, extractTendersAndPaginateThroughTable, extractTendersAndPaginateThroughCards, waitForPageReload } from './tender-data-scrapper.js';
...
export const CountryPlatformMap: Record<string, { searchUrl: string, startUrl: string }> = {
    ...
    PT: { searchUrl: 'https://www.base.gov.pt/Base4/pt/pesquisa/?type=contratos', startUrl: 'https://www.base.gov.pt/Base4/pt/' },
};
...
export function createRouterWithInput(keyword: string, maxResults: string, countries: string[]) {
    ...
    addPortugueseHandler(keyword, maxResults);
...
export function addPortugueseHandler(keyword: string, maxResults: string) {
